...
uses
  ...
  System.ImageList, Vcl.ImgList, UPesquisa;
...
begin
  if (EdCpfCnpj.Text <> '') and (EdNome.Text <> '') then
  begin
    try
      ...
      begin
        ...
        xFdQueryInsert.ParamByName('nome').AsString           := EdNome.Text;
        xFdQueryInsert.ParamByName('cpf_cnpj').AsString       := EdCpfCnpj.Text;
        xFdQueryInsert.ParamByName('flg_cliente').AsString    := 'S';
        xFdQueryInsert.ParamByName('flg_fornecedor').AsString := 'N';
        xFdQueryInsert.ParamByName('parceria').AsInteger := CbParceria.ItemIndex;
