...
type
  TFMovimentoEntrada = class(TForm)
    ...
    FdMovimentoItem: TFDTable;
    DsMovimentoItem: TDataSource;
    FdMovimentoItemcod_item_movimento: TFMTBCDField;
    FdMovimentoItemcod_produto: TFMTBCDField;
    FdMovimentoItempreco: TBCDField;
    FdMovimentoItemquantidade: TBCDField;
    FdMovimentoItemtp_unidade_medida: TWideStringField;
    FdMovimentoItemdata_validade: TDateField;
    FdMovimentoItemdata_fabricacao: TDateField;
    FdMovimentoItemcod_movimento: TFMTBCDField;
    DBGrid2: TDBGrid;
    DsMovimentoPagamento: TDataSource;
    FdMovimentoPagamento: TFDTable;
    FdMovimentoPagamentocod_pagamento: TFMTBCDField;
    FdMovimentoPagamentocod_movimento: TFMTBCDField;
    FdMovimentoPagamentotp_pagamento: TFMTBCDField;
    FdMovimentoPagamentovalor: TBCDField;
    FdMovimentoItempreco_unitario: TBCDField;
    BtFinalizar: TButton;
...
begin
  try
    ...
    FdMovimentoItem.Filter := ' cod_movimento = ' + IntToStr(FSequenciaMovimento);
    FdMovimentoItem.Filtered := True;
    FdMovimentoItem.Active := True;

    FdMovimentoPagamento.Filter := ' cod_movimento = ' + IntToStr(FSequenciaMovimento);
    FdMovimentoPagamento.Filtered := True;
    FdMovimentoPagamento.Active := True;
...
begin
  try
    ...
    xFbMovimentoPagamento.SQL.Add('        cod_pagamento, cod_movimento, tp_pagamento, valor) ');
    xFbMovimentoPagamento.SQL.Add(' VALUES (:cod_pagamento, :cod_movimento, :tp_pagamento, :valor) ');
